...
// import { login } from '../../../../Apis/authApi' // Make sure this is a Redux thunk, not a direct API call!
...
//   const [loading, setLoading] = useState(false)
//   const navigate = useNavigate()
//   const dispatch = useDispatch() // <-- This is necessary for Redux thunks
...
//     setLoading(true)
//     try {
//       // This assumes 'login' is a thunk that handles error and navigation
//       await dispatch(login(email, password, navigate))
//       // If your thunk navigates on success, you don't need to navigate here
//     } catch (err) {
...
//       <div className="flex min-h-screen ">
//         {/* Left side with form */}
//         <div className="relative w-[100%] sm:w-1/2 flex flex-col items-center justify-center bg-black text-white p-8 shadow-2xl shadow-gray-800 relative backdrop-blur-lg">
